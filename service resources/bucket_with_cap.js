(async () => {
	...
	await Joining.installSubscription('ns=3;s="RFID_IN_1"', async function(dataValue){
		...
		// extend seperator
		await Joining.writeNodes({
			nodeId: 'ns=3;s="FB_OPC_Remote_Control_DB"."xExtendSeperator"',
			attributeId: node_opcua.AttributeIds.Value,
			value: {
				value: {
					dataType: node_opcua.DataType.Boolean,
		...
		await Joining.writeNodes(
			[
				{
					nodeId: 'ns=3;s="FB_OPC_Remote_Control_DB"."xExtendSlide"',
					attributeId: node_opcua.AttributeIds.Value,
					value: {
						value: {
							dataType: node_opcua.DataType.Boolean,
				...
				{
					nodeId: 'ns=3;s="FB_OPC_Remote_Control_DB"."xRetractSlide"',
					attributeId: node_opcua.AttributeIds.Value,
					value: {
						value: {
							dataType: node_opcua.DataType.Boolean,
		...
		// extend suction cup
		await Joining.writeNodes({
			nodeId: 'ns=3;s="FB_OPC_Remote_Control_DB"."xSuctionCupDownwards"',
			attributeId: node_opcua.AttributeIds.Value,
			value: {
				value: {
					dataType: node_opcua.DataType.Boolean,
		...
		// activate vacuum
		await Joining.writeNodes({
			nodeId: 'ns=3;s="FB_OPC_Remote_Control_DB"."xVacuumOn"',
			attributeId: node_opcua.AttributeIds.Value,
			value: {
				value: {
					dataType: node_opcua.DataType.Boolean,
